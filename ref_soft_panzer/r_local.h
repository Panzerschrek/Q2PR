...
extern cvar_t   *r_use_multithreading;
extern cvar_t   *r_lightmap_mode;
...
void Sys_CreateMutex( qmutex_t* m );
//qmutex_t Sys_OpenMutex( const char* name );
